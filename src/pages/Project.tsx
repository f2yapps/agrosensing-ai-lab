...
export default function Project() {
  return (
    <>
      ...
      <p>My research program addresses a fundamental challenge in sustainable agriculture: how to optimize water and nutrient use while adapting to climate variability. I am prepared to establish the <strong>AgroSensing &amp; Intelligent Systems Lab</strong>, which will integrate physics-based hydrological modeling with artificial intelligence to develop deployable decision support systems for precision agriculture. The program will combine multi-scale sensing (UAV, satellite, IoT), high-performance computing, and digital twin technologies to deliver actionable intelligence for water managers, farmers, and conservation agencies. This work directly supports USDA-NIFA priorities in precision agriculture and water quality, NSF initiatives in cyber-physical systems and AI for environmental monitoring, NASA applications in agricultural remote sensing, and DOE objectives in the water-energy nexus.</p>
      ...
      <p><strong>Funding Target: USDA-NIFA AFRI, NSF CPS</strong> | Building on established expertise in IoT sensor networks, UAV remote sensing, and HPC-enabled digital twins, this research will optimize irrigation and reduce nutrient losses in tile-drained agricultural systems. The program will deploy physics-informed neural networks that couple soil water physics with machine learning for real-time irrigation decision support. Field validation across Mid-Atlantic watersheds will quantify water savings and nutrient-load reductions, directly supporting Chesapeake Bay restoration goals. Required lab infrastructure includes UAV platforms, IoT sensor networks, edge computing systems, and partnerships with USDA-ARS and regional water authorities.</p>
      ...
      <p><strong>Funding Target: USDA-NRCS CIG, NASA Carbon Monitoring</strong> | This research will scale high-resolution soil organic carbon (SOC) mapping using integrated UAV-proximal sensor fusion (FT-IR spectrometry, electromagnetic induction) and interpretable machine learning models. The program will establish validation protocols for USDA-NRCS conservation program outcomes and carbon credit verification. Coupling SOC dynamics with climate scenario modeling will evaluate adaptation strategies (deficit irrigation, cover cropping, conservation tillage) under projected warming and precipitation shifts. The research requires long-term field monitoring sites, soil sensing equipment, and computational infrastructure for process-based carbon modeling (RothC, DayCent).</p>
      ...
      <p><strong>Funding Target: USDA-NIFA AFRI (Plant Health), NSF AI Institutes</strong> | This program will deploy operational AI systems for early detection of biotic and abiotic stresses using multi-platform sensing (UAV multispectral/thermal, ground-based IoT) and modified CNN architectures validated under diverse field conditions. The framework will extend to livestock health through smartphone-based disease diagnosis, addressing veterinary service gaps in underserved regions. Research will integrate high-throughput phenotyping with breeding programs and develop explainable AI models for grower adoption. Required infrastructure includes controlled-environment facilities, image annotation systems, and partnerships with extension networks for real-world deployment.</p>
      ...
      <p><strong>Funding Target: NSF PIRE, USAID Feed the Future</strong> | Building on existing international networks, this research will apply AI and sensing technologies to smallholder farming systems in data-scarce environments. The program will develop low-cost, smartphone-based tools for soil assessment and irrigation guidance deployable in resource-limited settings. Expanding current mentorship initiatives will connect students in developing regions with research opportunities, strengthening diversity in agricultural and environmental sciences. This work positions the program for NSF international partnerships and USAID development programs aligned with global food security objectives.</p>
