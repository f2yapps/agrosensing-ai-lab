export default function Project() {
  return (
    <>
      ...
      <h2>Livestock Disease Diagnosis Using AI and Mobile Imaging</h2>
      <p>Building a mobile application that uses AI classification models to identify cattle diseases from smartphone camera images and text inputs describing symptoms. This tool provides rapid, accessible diagnostic support for farmers in resource-limited settings, addressing veterinary service gaps and improving livestock health management in Maryland and developing regions.</p>

      <h2>Climate Adaptation Strategies for Maryland Agriculture</h2>
      <p>Assessing climate change impacts on Maryland crop production, water resources, and soil health using crop models, hydrological simulations, and climate projections. This research evaluates adaptation strategies including deficit irrigation, heat-tolerant crop varieties, cover cropping, and conservation practices to enhance agricultural resilience under projected temperature increases, precipitation variability, and extreme weather events.</p>

      <h2>Nutrient Management and Water Quality Improvement in the Chesapeake Bay Watershed</h2>
      <p>Quantifying nutrient (nitrogen, phosphorus) dynamics in agricultural systems and evaluating best management practices (BMPs) for reducing nutrient loads to the Chesapeake Bay. This project combines field monitoring, water quality modeling, and AI to assess effectiveness of controlled drainage, cover crops, precision fertilizer application, and other BMPs in meeting Maryland's Total Maximum Daily Load (TMDL) commitments.</p>

      <h2>Urban Agriculture and Green Infrastructure Optimization</h2>
      <p>Applying AI, remote sensing, and IoT to optimize urban agriculture systems, community gardens, and green infrastructure in Maryland cities. This work supports urban food production, stormwater management, heat island mitigation, and community resilience through data-driven design and management of urban agricultural and green spaces.</p>
