export default function Home() {
  return (
    <>
      ...
      <h2>About</h2>
      <p>Fitsum Teshome is a Postdoctoral Research Associate at the University of Maryland, where he advances interdisciplinary solutions at the nexus of artificial intelligence, precision agriculture, and environmental sustainability. He earned his Ph.D. in Agricultural and Biological Engineering from the University of Florida. His research spans four interconnected thematic areas: <strong>Agricultural Water Management</strong>, <strong>Modeling &amp; Soil Science</strong>, <strong>AI, Digital Agriculture &amp; Smart Technologies</strong>, and <strong>Remote &amp; Proximal Sensing for Agroecosystems</strong>.</p>
      
      <p>Dr. Teshome develops integrated frameworks that combine UAV and satellite imagery, IoT-enabled sensor networks, edge computing, high-performance computing, and digital twin technologies with machine learning and process-based models. His work encompasses precision irrigation scheduling, drainage water management, soil organic carbon monitoring, high-throughput plant phenotyping, and AI-driven disease detection for both crops and livestock. He has advanced tools such as AgriSenAI for automated UAV image processing, AI-enabled mobile applications for irrigation decision support, and predictive models for rootzone soil moisture dynamics, evapotranspiration, and canopy temperature using RGB and multispectral imagery.</p>
      
      <p>His research addresses critical challenges in water conservation through deficit irrigation strategies, soil hydrologic dynamics simulation, and climate adaptation, including assessing sea-level rise impacts on coastal groundwater systems. With expertise in hydrological modeling, geospatial analytics, and environmental sensing systems, Dr. Teshome bridges physics-based understanding with intelligent systems to deliver scalable, data-driven solutions that enhance agricultural resilience, optimize resource use, and support sustainable management under climate variability.</p>
