...
export default function Home() {
  return (
    <>
      ...
      <h2>About</h2>
      <p>I am a Post-Doctoral Research Associate at the University of Maryland working in precision and digital agriculture. I hold a Ph.D. from the University of Florida. My research focuses on surface and subsurface hydrology, with particular emphasis on applying advanced tools, i.e., AI and ML algorithms, water stress indices, and hydrological models. I have several years of research and teaching experience in global change science, geospatial technologies, proximal sensing, edge computing, high-performance computing, IoT systems, digital twins, drone imaging, and water resources modeling. My research integrates artificial intelligence (AI), remote sensing, Internet of Things (IoT) sensor networks and digital twins, environmental sensing networks, and process-based modeling to improve decision-making in plant-based agriculture and natural resource systems. I develop scalable, data-driven frameworks that combine machine learning, geospatial analytics, high-performance computing (HPC), and crop-soil-hydrologic models to optimize water and nutrient management, enhance soil health monitoring, and increase agroecosystem resilience under climate variability.</p>
      ...
      <p>I fuse UAV multispectral and thermal imagery, in-field soil moisture sensors, and weather data with machine learning and crop models to predict soil moisture dynamics, evapotranspiration, crop water stress, and nutrient variability. This work underpins decision-support tools such as AgriSenAI, an automated UAV image processing pipeline for precision irrigation, nutrient management, and yield forecasting under variable irrigation regimes.</p>

      <h3>Soil carbon modeling and ecosystem resilience</h3>
      <p>I leverage process-based soil carbon models (RothC, DayCent, and Century) along with AI models and geospatial analytics to develop high-resolution soil organic carbon maps and predict carbon dynamics under climate stress. By integrating terrain attributes, multisource remote sensing, and machine learning, I support carbon-smart agriculture, conservation targeting, and climate mitigation strategies.</p>

      <h3>Hydrologic dynamics and water resource management</h3>
      <p>I apply hydrological models and AI to evaluate soil-water-nutrient interactions and water fluxes under variable management and climate conditions. By integrating crop models, machine learning, and uncertainty-aware modeling, I support irrigation optimization, water quality improvement, and sustainable water resource management.</p>
