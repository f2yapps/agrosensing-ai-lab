const RESEARCH_HIGHLIGHTS = [
  ...
  { img: '/images/Highlights/Highlights1.jpg', alt: 'Graphical abstract', title: 'Evapotranspiration Prediction Using UAV-Based Imagery and Artificial Intelligence Algorithms', summary: 'Using UAV-based multispectral and thermal imagery with artificial intelligence algorithms to estimate crop evapotranspiration for field-scale water use assessments. These estimates help quantify actual water use and support irrigation planning and water budgeting.' },
  { img: '/images/Highlights/Highlights9.png', alt: 'Graphical abstract', title: 'High-Throughput Plant Phenotyping Using Unmanned Aerial Vehicle (UAV) Imagery and Artificial Intelligence Algorithms', summary: 'Leveraging multispectral and thermal UAV data with AI to extract crop traits, monitor growth, and detect stress at scale for breeding and precision agriculture. The approach enables rapid, non-destructive assessment of large field trials and commercial fields.' },
  { img: '/images/Highlights/Highlights5.jpg', alt: 'Graphical abstract', title: 'Canopy Temperature Prediction Using RGB Images and Artificial Intelligence Algorithms', summary: 'Using RGB imagery with machine learning to predict canopy temperature for crop water status and growth monitoring. Low-cost RGB cameras can thus support irrigation and stress detection where thermal sensors are not available.' },
  { img: '/images/Highlights/Highlights6.jpg', alt: 'AgriSenAI image processing pipeline', title: 'AgriSenAI: Automating UAV Thermal and Multispectral Image Processing for Precision Agriculture', summary: 'An automated pipeline that processes UAV thermal and multispectral imagery from acquisition through analytics, enabling consistent, scalable image handling for precision agriculture. Standardized workflows reduce processing time and support repeatable research and operational use.' },
  { img: '/images/Highlights/Hightlights13.png', alt: 'AI-enabled precision irrigation decision support', title: 'Artificial Intelligence–Enabled Precision Irrigation Decision Support', summary: 'AI-driven decision-support that uses UAV thermal and multispectral imagery to recommend when and where to irrigate, helping optimize water use and crop management. The tool integrates imagery, soil and weather data, and model outputs to deliver actionable irrigation guidance at field scale.' },
  { img: '/images/Highlights/Hightlights8.jpg', alt: 'Graphical abstract', title: 'Exploring Deficit Irrigation as a Water Conservation Strategy: Insights from Field Experiments and Model Simulation', summary: 'Field experiments and model simulations to evaluate deficit irrigation for water savings while maintaining yield, with insights for sustainable water use in agriculture. Results inform irrigation strategies under water-limited conditions and variable climate.' },
  { img: '/images/Highlights/Hightlights7.png', alt: 'Graphical abstract', title: 'Predicting Sea-Level Rise Impacts on Groundwater Quantity and Quality in Complex Hydrogeological Systems', summary: 'Modeling and predicting how sea-level rise affects groundwater levels and salinity in complex coastal hydrogeological systems to support adaptation planning. The work helps identify vulnerable zones and prioritize management and policy responses.' },
  { img: '/images/Highlights/Highlights10.png', alt: 'Graphical abstract', title: 'Simulating Soil Hydrologic Dynamics Using Crop Growth and Machine Learning Models', summary: 'Integrating crop growth and hydrological models with machine learning to simulate soil moisture and water fluxes under variable management and climate. The combined approach improves predictions of soil water availability and supports irrigation and nutrient management decisions.' },
  { img: '/images/Highlights/Highlights14.png', alt: 'Graphical abstract', title: 'Integration of Smartphone Imagery with Topographic Parameters for Soil Organic Carbon Prediction in the Indo-Gangetic Plains: An Interpretable Machine Learning Approach', summary: 'Combining smartphone-captured imagery and topographic data with interpretable machine learning to predict soil organic carbon across the Indo-Gangetic Plains for sustainable land management. The method offers a low-cost, scalable option for SOC mapping where conventional sampling is limited.' },
  { img: '/images/Highlights/highlights17.png', alt: 'Graphical abstract', title: 'Application of Artificial Intelligence Algorithm in Image Processing for Cattle Disease Diagnosis', summary: 'Integrating expert systems with deep learning image processing to identify livestock diseases from symptom images and support rapid, effective diagnosis in resource-limited settings. The system helps bridge diagnostic gaps where veterinary expertise or lab access is limited.' },
]
...
export default function Home() {
  return (
    <>
      ...
      <h2>Our Mission</h2>
      <p>The AgroSensing &amp; AI Lab focuses on building AI-enabled agricultural and environmental intelligence systems that reduce production inputs, strengthen sustainability, and directly benefit farmers and communities. We integrate UAV and satellite imagery, IoT-enabled soil and crop sensor networks, weather data, and process-based models with interpretable machine learning, digital twin representations, and high-performance computing (HPC) to support precision water and nutrient management, soil carbon monitoring, and ecosystem resilience. Positioned within the University of Maryland's Land Grant mission and the AI Interdisciplinary Institute @ Maryland (AIM), our lab leverages an exceptional interdisciplinary ecosystem to translate advanced analytics into practical decision-support tools.</p>

      <h2>Main Research Areas</h2>
      <h3>AI-driven precision water and nutrient management</h3>
      <p>We fuse UAV multispectral and thermal imagery, in-field soil moisture sensors, and weather data with machine learning and crop models to predict soil moisture dynamics, evapotranspiration, and crop stress. This work underpins decision-support tools such as AgriSenAI, an automated UAV image processing pipeline for precision irrigation and yield forecasting under variable irrigation regimes.</p>

      <h3>Soil carbon, hydrologic dynamics, and ecosystem resilience</h3>
      <p>We apply AI and geospatial analytics to develop high-resolution soil organic carbon maps and evaluate soil–water–carbon interactions under climate stress. By integrating terrain attributes, multisource remote sensing, and hydrological modeling with uncertainty-aware machine learning, we support carbon-smart agriculture, conservation targeting, and nutrient management—particularly in landscapes such as the Indo-Gangetic Plains and the Chesapeake Bay watershed.</p>

      <h3>AI and image processing for animal health and agricultural systems</h3>
      <p>Beyond crop systems, I have experience applying AI to livestock health. In cattle-focused work in Ethiopia, I contributed to an expert system integrated with deep learning image processing for timely disease diagnosis: cell-phone–captured symptom images were classified by a CNN with 95% accuracy, and a reasoner combined image outputs with location and text inputs to deliver rapid, effective recommendations—addressing critical diagnostic gaps where livestock are central to food security and livelihoods.</p>
